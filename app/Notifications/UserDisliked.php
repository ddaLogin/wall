...
class UserDisliked extends Notification
{
    use Queueable;
     ...
     */
    public function __construct(Models\Post $post, Models\User $user)
    {
        $this->post = $post;
        $this->user = $user;
    }
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'text' => __('notifications.App\Notifications\UserDisliked', [
