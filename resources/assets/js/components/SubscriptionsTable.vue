<template>
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#subscriptions" aria-controls="subscriptions" role="tab" data-toggle="tab">Subscriptions <span class="badge">{{filteredSubscriptions.length}}</span></a></li>
            <li role="presentation"><a href="#subscribers" aria-controls="subscribers" role="tab" data-toggle="tab">Subscribers <span class="badge">{{filteredSubscribers.length}}</span></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="subscriptions">
                <ul class="list-group">
                    <li v-for="subscription in filteredSubscriptions" class="list-group-item"><a :href="subscription.target.link">{{subscription.target.nickname}}</a></li>
            ...
            <div role="tabpanel" class="tab-pane" id="subscribers">
                <ul class="list-group">
                    <li v-for="subscriber in filteredSubscribers" class="list-group-item"><a :href="subscriber.user.link">{{subscriber.user.nickname}}</a></li>
